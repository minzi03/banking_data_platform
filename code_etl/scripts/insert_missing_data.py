...
for i in range(1, 2001):
    ...
    merchants.append(
        (
            ...
            f"Merchant_{i:04d}",
            cat,
            f"{cat[:3]}{random.randint(1000, 9999)}",
            city,
            city,
            random.choices(risk_levels, weights=risk_weights, k=1)[0],
            1,
            datetime.now(),
        )
    )
...
for i in range(1, 501):
    ...
    """,
        (
            ...
            f"Alert for customer {cust_id}",
            round(random.uniform(1000000, 5000000000), 2),
            created,
...
print("  AML Customer Risk: 200 rows")
