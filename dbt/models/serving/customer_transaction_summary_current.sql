-- =============================================================================
-- Serving: customer_transaction_summary_current   (wave 1)
-- =============================================================================
...
{{ config(materialized='table', schema='serving', tags=['serving', 'current_serving', 'wave1']) }}
...
select *
from {{ source('gold', 'customer_transaction_summary') }}
