-- =============================================================================
-- Serving: mart_customer_360_current   (wave 3)
-- =============================================================================
...
--             và cho Spark VIEW mà Trino KHÔNG nhìn thấy (serving visibility finding)
--
...
{{ config(materialized='table', schema='serving', tags=['serving', 'current_serving', 'wave3']) }}
